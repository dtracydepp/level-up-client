        ...
        <form className="gameForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input name="description" type="text" onChange={changeEventState} defaultValue={currentEvent.description}/>
                </div>
            </fieldset>
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input name="date" type="datetime-local" onChange={changeEventState} defaultValue={currentEvent.date}/>
                </div>
            </fieldset>
